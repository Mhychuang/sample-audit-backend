const { getUserByEmail, updatePassword,getCoutyValue,getAppList } = require("../dboperation/user");
...
module.exports = { getUserLogin, updateWebUser, getCountyValueCon,getAppListCon,}